function grafico(parametros) {
    ...
    let fnX = d3.scaleLinear().domain([0, parametros.dados.length]).range([0, larguraPlotagem]);
    let fnY = d3.scaleLinear().domain([0, d3.max(parametros.dados)]).range([alturaPlotagem, 0]);
